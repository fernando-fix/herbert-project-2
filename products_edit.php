    ...
    <div style="max-width: 500px; min-width: 250px;">
        <form action="products_edit_action.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="patrimony" name="patrimony" placeholder="Ex: 3254" value="<?= $product['patrimony']; ?>" required>
            </div>

            <div class="mb-3">
                <label for="product_name" class="form-label">Nome do produto</label>
                <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Ex: Computador Dell" value="<?= $product['name']; ?>" required>
            </div>

            <div class="mb-3">
                <label for="product_descr" class="form-label">Descrição do produto</label>
                <textarea class="form-control" id="product_descr" name="product_descr" rows="3" required><?= $product['description']; ?></textarea>
            </div>
